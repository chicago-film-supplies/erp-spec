...
| [ADR-0045](ADR-0045-a-jurisdiction-is-a-registration-and-the-record-says-which-rung-answered.md) | A tax jurisdiction is a registration rather than a claim about use, and the record stores which rung of the precedence answered — so a derived answer is never mistaken for an asserted one | 2026-11-30 | — | `OQ-056` `OQ-057` |
