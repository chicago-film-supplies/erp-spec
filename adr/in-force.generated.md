...
| [ADR-0047](ADR-0047-the-client-data-model-live-transport-and-offline-queue.md) | The client data model — one live transport replacing Firestore listeners, and an offline queue reconciled by three-way merge | 2026-11-15 | — | `OQ-043` `OQ-061` |
| [ADR-0048](ADR-0048-the-plaid-ingestion-boundary.md) | The Plaid ingestion boundary — a MongoDB inbox at the edge that does not post, CFS-minted identity, and delta-atomic application | 2026-11-30 | — | `OQ-062` `OQ-063` |
