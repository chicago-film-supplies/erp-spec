...
> bank and one account, **we decided** to source the feed from Plaid, **to achieve** a working
> feed without a bank-specific integration, **accepting** that Plaid's transaction model is a
...
- SPIKE-004 must establish what Plaid actually gives us before any reconciliation design: pending
  vs posted semantics, the balance endpoints, the backfill window, and — critically — whether
