...
Two to four lines. One idea per file. Standalone — no reference to conversational context.
Never rewritten after it lands; corrections go in a new file that supersedes this one.
