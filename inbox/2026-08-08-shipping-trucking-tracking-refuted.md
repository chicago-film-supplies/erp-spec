...
Exactly ONE product of 549 has a null tracking dimension: "Chicago Bottled Water Tax ( $0.05/bottle
)", a `sale` product booking to COA 2210 — a liability account, not revenue. That one is arguably
correct as-is.
