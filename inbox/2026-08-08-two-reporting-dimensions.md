...
Trash & Cleanup product lines, so the account cannot stand in for the product line — and the product
line cannot tell you whether the labour was a delivery run or warehouse time.
